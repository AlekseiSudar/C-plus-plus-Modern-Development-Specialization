...
struct AddressHasher {
    size_t operator()(const Address& address) const {
        ...
        return coef * coef * s_hasher(address.city) +
                      coef * s_hasher(address.street) +
                             i_hasher(address.building);
    }
...
struct PersonHasher {
    size_t operator()(const Person& person) const {
        ...
        return coef * coef * coef * a_hasher(person.address) +
                      coef * coef * s_hasher(person.name) +
                             coef * d_hasher(person.weight) +
                                    i_hasher(person.height);
    }
