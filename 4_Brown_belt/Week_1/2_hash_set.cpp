...
public:
    ...
    void Add(const Type& value){
        auto bl = &data_[hasher_(value) % data_.size()];
    ...
    bool Has(const Type& value) const{
        auto bl = &data_[hasher_(value) % data_.size()];
        return find(bl->begin(), bl->end(), value) != bl->end();
    }
    void Erase(const Type& value){
        data_[hasher_(value) % data_.size()].remove(value);
    }
    const BucketList& GetBucket(const Type& value) const{
        return data_[hasher_(value) % data_.size()];
    }
